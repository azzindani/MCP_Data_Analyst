...
mcp = FastMCP("data_transform", auth=build_token_verifier("DA", _oauth_bridge, base_url=_base_url))
...
def main() -> None:
    ...
    parser.add_argument("--host", default=os.environ.get("DA_TRANSFORM_HOST", "127.0.0.1"))
    parser.add_argument("--port", type=int, default=int(os.environ.get("DA_TRANSFORM_PORT", "8813")))
